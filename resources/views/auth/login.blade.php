                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span style="text-transform: unset;" class="app-brand-text demo text-body fw-bolder">Munshi Portal</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form method="POST" class="mb-3" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="any" class="form-control @error('phone') is-invalid @enderror" name="phone"
                                value="{{ old('phone') }}" placeholder="Enter Phone No" required autocomplete="phone" autofocus />
                            </div>
