                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" step="any" name="user_name2" class="form-control"
                                            id="phone" placeholder="Second user name" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="">2nd User Designation:</label>
                                        <input type="text" step="any" name="user_designation2" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number" step="any" name="user_ip" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="unit_password" value="abc123" class="form-control"
                                            id="unit_password" placeholder="Unit Password" required />
                                    </div>
                                </div>
